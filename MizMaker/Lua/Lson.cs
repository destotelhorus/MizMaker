...
using System.Text;
using MizMaker.Lua;
using MizMaker.Lua.Private;

namespace MizMaker.Lua
{
    /// <summary>
    ...
    {
        public static bool SerializeImplicitIndex = false;
        ...
        public override void AppendIndented(StringBuilder sb, int indentation = 0)
        {
            ...
            foreach (var kvp in Dict)
            {
                ...
                for (int i = 0; i <= indentation; i++)
                    sb.Append('\t');
                if (SerializeImplicitIndex && kvp.Key.Equals((LsonNumber) implicitIndex))
                {
